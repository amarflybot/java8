package amar.code.function_composition;
...
public class Sample {
    ...
    public static int computeSumOfDoubleOf1000EvenFrom(final int starting) {
        int count = 0;
        int total = 0;
        int number = starting;
    ...
    public static int computeSumOfDoubleOf1000EvenFromFunctional(final int starting) {
